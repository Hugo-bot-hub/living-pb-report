"""2026-06-27 (Sat) daily update.
Full replace of SRP/inflow/cvr/benchmark/scoreTs/featTs. Daily anchored at
2026-06-25 (06-26 UV not yet landed in commerce_daily_user_count_v3 -> no new
complete daily row; rule: never append a row missing imp_uv/pdp_uv/buy_uv).
Query E (ages) skipped: 2026-06-27 is Saturday (Monday-only rule).
...
TMP = Path("tf-data/tmp_2026_06_27")
