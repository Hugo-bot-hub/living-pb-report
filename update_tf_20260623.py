"""2026-06-23 daily update: append 2026-06-22 daily row (PV+UV complete)
+ full replace of SRP/inflow/cvr/benchmark/scoreTs/featTs.
Query E (ages) skipped: 2026-06-23 is Tuesday (Monday-only rule) -> ages untouched.
"""
import json
import sys
from pathlib import Path

TMP = Path("tf-data/tmp_2026_06_23")
PIDS = ["3918642", "3640244", "767440", "2636441", "1930788", "442026"]
REFRESH_FROM = "2026-06-22"
DAILY_CUTOFF = "2026-06-22"  # last date with complete PV+UV data
