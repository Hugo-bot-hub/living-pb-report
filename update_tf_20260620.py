"""2026-06-20 daily update: rebuild daily 2026-06-08~06-19 (PV+UV complete to 06-19)
+ full replace of SRP/inflow/cvr/benchmark/scoreTs/featTs.
Query E (ages) skipped: 2026-06-20 is Saturday (Monday-only rule).
"""
import json
import sys
from pathlib import Path

TMP = Path("tf-data/tmp_2026_06_20")
PIDS = ["3918642", "3640244", "767440", "2636441", "1930788", "442026"]
REFRESH_FROM = "2026-06-08"
DAILY_CUTOFF = "2026-06-19"  # last date with complete PV+UV data
